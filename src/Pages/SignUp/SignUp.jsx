                ...
                <form onSubmit={handleSubmit(onSubmit)} className="bg-white shadow rounded lg:w-1/3  md:w-1/2 w-full p-10">
                    ...
                    <div className="mt-6 flex gap-4 justify-between">
                        <div>
                            ...
                            <select {...register("gender")} className="bg-gray-200 border rounded focus:outline-none text-xs font-medium leading-none text-gray-800 py-3 w-full mt-2">
                        ...
                        <div>
                            ...
                            <input {...register("phone")} type="tel" className="bg-gray-200 border rounded focus:outline-none text-xs font-medium leading-none text-gray-800 py-3 w-full pl-3 mt-2" />
                        </div>
                        <div>
                            <label className="text-sm font-medium leading-none text-gray-800">Address</label>
                            <input {...register("address")} type="text" className="bg-gray-200 border rounded focus:outline-none text-xs font-medium leading-none text-gray-800 py-3 w-full pl-3 mt-2" />
                        </div>
