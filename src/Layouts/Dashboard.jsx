        ...
        <div className="drawer lg:drawer-open">
            ...
            <div className="drawer-side">
                ...
                <ul className="menu p-4 w-80 h-full bg-base-200 text-base-content">
                    ...
                    {
                        isAdmin ? <>
                            <li><NavLink to={'/dashboard/admin-home'} className={({ isActive }) => isActive ? 'text-[#ab14a3]' : 'text-[#757575]'}><button>Admin Home</button></NavLink></li>
                            <li><NavLink to={'/dashboard/manage-classes'} className={({ isActive }) => isActive ? 'text-[#ab14a3]' : 'text-[#757575]'}><button>Manage Classes</button></NavLink></li>
                            <li><NavLink to={'/dashboard/manage-users'} className={({ isActive }) => isActive ? 'text-[#ab14a3]' : 'text-[#757575]'}><button>Manage Users</button></NavLink></li>

                        </> : <>
                            {
                                isInstructor ? <>
                                    <li><NavLink to={'/dashboard/instructor-home'} className={({ isActive }) => isActive ? 'text-[#ab14a3]' : 'text-[#757575]'}><button>Instructor Home</button></NavLink></li>
                                    <li><NavLink to={'/dashboard/add-class'} className={({ isActive }) => isActive ? 'text-[#ab14a3]' : 'text-[#757575]'}><button>Add a Class</button></NavLink></li>
                                    <li><NavLink to={'/dashboard/my-classes'} className={({ isActive }) => isActive ? 'text-[#ab14a3]' : 'text-[#757575]'}><button>My Classes</button></NavLink></li>
                                </> : <>
